...
public class PickYourPath {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
            "You are a master chef cooking in your restaurant\n" +
        ...
        if (choice == 1) {
            System.out.println(
                "Oh no, it turns out that it was a grease fire\n" +
            ...
            if (choice == 1) {
                System.out.println(
                    "Your customers appreciated your tact and decide\n" +
                ...
                if (choice == 1) {
                    System.out.println(
                        "The oven you purchased had a defect,\n" +
                        "and you wasted all of your money. :("
                    );
                } else if (choice == 2) {
                    System.out.println(
                        "You spent a relaxing week in an island\n" +
