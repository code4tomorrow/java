...
public static void main(String[]args){
	...
	song += jingleMaster(57) + jingleMaster(72) + jingleMaster(75) +  jingleMaster(57) + jingleMaster(72) + jingleMaster(75) + jingleMaster(57) + jingleMaster(87) + jingleMaster(84) + jingleMaster(75) + jingleMaster(96) + jingleMaster(75) + jingleMaster(99) + jingleMaster(81) + jingleMaster(75);
...
public static String jingleMaster(int a){
	String outputString = "";
	switch ((a/3+10) % 23) {
		case 20: outputString += "W\n";
				break;
		case 19: outputString += "T\n";
		case 18: outputString += "h\n";
		case 17: outputString += "e\n";
				break;
		case 16: outputString += "A\n";
		case 15: outputString += "l\n";
				break;
		case 14: outputString += "a\n";
		case 13: outputString += "y\n";
				break;
